                    ...
                    preFilter: {
                        ...
                        PSEUDO: function (e) {
                            ...
                            return U.CHILD.test(e[0])
                                ? null
                                : (e[4] ? (e[2] = e[4]) : n && z.test(n) && (t = ft(n, !0)) && (t = n.indexOf(")", n.length - t) - n.length) && ((e[0] = e[0].slice(0, t)), (e[2] = n.slice(0, t))), e.slice(0, 3));
                        },
                    },
                    filter: {
                        TAG: function (e) {
        ...
        $(this).each(function () {
            ...
            $daddy.on("mousedown touchstart", jq, function (e) {
                ...
                if (mouse.target == !1 && active == !0 && (e.which == 1 || e.type == "touchstart")) {
                    ...
                    mouse.clone.removeClass(childrenClass).css({ position: "absolute", top: mouse.y - mouse.cloneoffset.y, left: mouse.x - mouse.cloneoffset.x });
...
function removeAttrs(e) {
    e.childNodes.forEach(function (e) {
        e.hasChildNodes() && removeAttrs(e), "#text" !== e.nodeName.toLowerCase() && (e.hasAttribute("style") || e.hasAttribute("class")) && (e.removeAttribute("style"), e.removeAttribute("class"));
    });
}
    ...
    for (var t = e.childNodes, a = !0; a; )
        (a = !1),
            t.forEach(function (e) {
                ...
                var t = e.nodeName.toLowerCase();
                if (("#text" !== t && (e.hasAttribute("style") || e.hasAttribute("class")) && (e.removeAttribute("style"), e.removeAttribute("class"), (a = !0)), "div" === t || "p" === t)) {
                    var n,
                        i = e.parentNode;
                    for (e.lastChild && "br" !== e.lastChild.nodeName.toLowerCase() && ((n = document.createElement("br")), e.appendChild(n)); e.firstChild; ) i.insertBefore(e.firstChild, e);
                    i.removeChild(e), (a = !0);
                } else if ("font" === t || "span" === t) {
                    for (i = e.parentNode; e.firstChild; ) i.insertBefore(e.firstChild, e);
                    i.removeChild(e), (a = !0);
                } else if ("br" === t)
                    (e.nextSibling && "br" === e.nextSibling.nodeName.toLowerCase()) || (e.previousSibling && "br" === e.previousSibling.nodeName.toLowerCase())
                        ? (e.remove(), (a = !0))
                        : e.previousSibling &&
                        e.nextSibling &&
                        "sup" === e.previousSibling.nodeName.toLowerCase() &&
                        "sup" === e.nextSibling.nodeName.toLowerCase() &&
                        ((o = e.nextSibling), (n = e.previousSibling).appendChild(e), (n.innerHTML += o.innerHTML), o.remove(), (a = !0));
                else if ("sup" === t && e.nextSibling && "sup" === e.nextSibling.nodeName.toLowerCase()) {
                    var o = e.nextSibling;
                    (e.innerHTML += o.innerHTML), o.remove(), (a = !0);
                } else if ("b" === t || "i" === t || "u" === t || "strike" === t || "em" === t || "strong" === t || "del" === t) {
                    var s = !1;
                    if (
                        (e.childNodes.forEach(function (e) {
                        ...
                        for (var r, i = e.parentNode; e.firstChild; )
                            "sup" === e.firstChild.nodeName.toLowerCase()
                                ? (((r = document.createElement(t)).innerHTML = e.firstChild.innerHTML), (e.firstChild.innerHTML = ""), e.firstChild.append(r), i.insertBefore(e.firstChild, e))
                                : ((r = document.createElement(t)).append(e.firstChild), i.insertBefore(r, e));
                        i.removeChild(e), (a = !0);
                    }
                }
            });
...
(function (e) {
    ...
    if ("Element" in e) {
        ...
        if (
            ((a[n] = Error[n]),
                ...
                (d.add = function () {
                    for (var e, t = arguments, n = 0, i = t.length, o = !1; -1 === l(this, (e = t[n] + "")) && (this.push(e), (o = !0)), ++n < i; );
                ...
                (d.remove = function () {
                    var e,
                        ...
                        s = !1;
                    do {
                        for (t = l(this, (e = n[i] + "")); -1 !== t; ) this.splice(t, 1), (s = !0), (t = l(this, e));
                    } while (++i < o);
            ...
            try {
                ...
                -2146823252 === e.number && ((u.enumerable = !1), o.defineProperty(i, t, u));
            }
    ...
    (function (e) {
            ...
            (function (e) {
                ...
                return (
                    ...
                    (m = e.URL = function (e) {
                        ...
                        return (t.href = e), "origin" in t || ("data:" === t.protocol.toLowerCase() ? (t.origin = null) : ((e = e.match(v)), (t.origin = e && e[1]))), t;
                    }),
                        (m.createObjectURL = function (e) {
                            ...
                            return (
                                null === t && (t = "application/octet-stream"),
                                    e instanceof l
                                        ? ((t = "data:" + t), "base64" === e.encoding ? t + ";base64," + e.data : "URI" === e.encoding ? t + "," + decodeURIComponent(e.data) : f ? t + ";base64," + f(e.data) : t + "," + encodeURIComponent(e.data))
                                        : u
                                            ? u.call(r, e)
                                            : void 0
                            );
                        ...
                        (n.append = function (e) {
                            ...
                            if (b && (e instanceof g || e instanceof b)) {
                                for (var n = "", i = new b(e), o = 0, s = i.length; o < s; o++) n += String.fromCharCode(i[o]);
                                t.push(n);
                                ...
                                e instanceof l
                                    ...
                                    : ("string" != typeof e && (e += ""), t.push(unescape(encodeURIComponent(e))));
                        }),
        ...
        e.Blob = function (e, t) {
            var t = (t && t.type) || "",
                n = new s();
            if (e) for (var i = 0, o = e.length; i < o; i++) Uint8Array && e[i] instanceof Uint8Array ? n.append(e[i].buffer) : n.append(e[i]);
            t = n.getBlob(t);
    ...
    (function (e, t) {
        "use strict";
        ("object" == typeof module && "undefined" != typeof process && process && process.versions && process.versions.electron) || "object" != typeof module
            ? "function" == typeof define && define.amd
                ? define(function () {
                    return t;
                })
        ...
        (function () {
            ...
            function c(e) {
                return d.util.isBlockContainer(e) ? NodeFilter.FILTER_ACCEPT : NodeFilter.FILTER_SKIP;
            }
            var n, i, o, s, r, e, a;
            function l(e, t) {
                return (
            ...
            function h(e) {
                ...
                Array.prototype.slice.call(e.parentElement.querySelectorAll("." + i)).forEach(function (e) {
            ...
            function f(e, t, n) {
                var i = e.clipboardData || t.clipboardData || n.dataTransfer,
                    o = {};
                if (!i) return o;
                if ((!i.getData || ((n = i.getData("Text")) && 0 < n.length && (o["text/plain"] = n)), i.types))
            ...
            function p(e, t) {
                this.options.disableReturn || t.getAttribute("data-disable-return")
                    ? e.preventDefault()
                    : (!this.options.disableDoubleReturn && !t.getAttribute("data-disable-double-return")) ||
                    ((((t = d.selection.getSelectionStart(this.options.ownerDocument)) && "" === t.textContent.trim() && "li" !== t.nodeName.toLowerCase()) ||
                            (t.previousElementSibling && "br" !== t.previousElementSibling.nodeName.toLowerCase() && "" === t.previousElementSibling.textContent.trim())) &&
                        e.preventDefault());
            }
            function g(e) {
                var t,
                    ...
                    o = /^(\s+|<br\/?>)?$/i,
                    s = /h\d/i;
                d.util.isKey(e, [d.util.keyCode.BACKSPACE, d.util.keyCode.ENTER]) && n.previousElementSibling && s.test(i) && 0 === d.selection.getCaretOffsets(n).left
                    ? d.util.isKey(e, d.util.keyCode.BACKSPACE) && o.test(n.previousElementSibling.innerHTML)
                        ? (n.previousElementSibling.parentNode.removeChild(n.previousElementSibling), e.preventDefault())
                        : !this.options.disableDoubleReturn &&
                        d.util.isKey(e, d.util.keyCode.ENTER) &&
                        (((t = this.options.ownerDocument.createElement("p")).innerHTML = "<br>"), n.previousElementSibling.parentNode.insertBefore(t, n), e.preventDefault())
                    : d.util.isKey(e, d.util.keyCode.DELETE) && n.nextElementSibling && n.previousElementSibling && !s.test(i) && o.test(n.innerHTML) && s.test(n.nextElementSibling.nodeName.toLowerCase())
                        ? (d.selection.moveCursor(this.options.ownerDocument, n.nextElementSibling), n.previousElementSibling.parentNode.removeChild(n), e.preventDefault())
                        ...
                        "li" === n.nextElementSibling.nodeName.toLowerCase()
                            ? (((t = this.options.ownerDocument.createElement("p")).innerHTML = "<br>"),
                                n.parentElement.parentElement.insertBefore(t, n.parentElement),
                                d.selection.moveCursor(this.options.ownerDocument, t),
                                n.parentElement.removeChild(n),
                                e.preventDefault())
                            : d.util.isKey(e, d.util.keyCode.BACKSPACE) && !1 !== d.util.getClosestTag(n, "blockquote") && 0 === d.selection.getCaretOffsets(n).left
                                ? (e.preventDefault(), d.util.execFormatBlock(this.options.ownerDocument, "p"))
                                : d.util.isKey(e, d.util.keyCode.ENTER) && !1 !== d.util.getClosestTag(n, "blockquote") && 0 === d.selection.getCaretOffsets(n).right
                                    ? (((t = this.options.ownerDocument.createElement("p")).innerHTML = "<br>"), n.parentElement.insertBefore(t, n.nextSibling), d.selection.moveCursor(this.options.ownerDocument, t), e.preventDefault())
                                    : d.util.isKey(e, d.util.keyCode.BACKSPACE) &&
                                    d.util.isMediumEditorElement(n.parentElement) &&
                                    !n.previousElementSibling &&
                                    n.nextElementSibling &&
                                    o.test(n.innerHTML) &&
                                    (e.preventDefault(), d.selection.moveCursor(this.options.ownerDocument, n.nextSibling), n.parentElement.removeChild(n));
            }
            function b(e, t, n) {
                var i = [];
                if (("string" == typeof (e = e || []) && (e = t.querySelectorAll(e)), d.util.isElement(e) && (e = [e]), n))
                    for (var o = 0; o < e.length; o++) {
                        var s = e[o];
                        !d.util.isElement(s) || s.getAttribute("data-medium-editor-element") || s.getAttribute("medium-editor-textarea-id") || i.push(s);
                    }
            ...
            function E(e, t, n) {
                var i,
                    o,
                    n = { window: n.options.contentWindow, document: n.options.ownerDocument, base: n };
                return (
                    (i = e),
                        (o = n),
            ...
            function y(e, t) {
                ...
                return (
                    ...
                    ((e = function (e) {
                        ...
                        for (var s = 0, r = o.length; s < r; s++) t.hasAttribute(o[s].nodeName) || t.setAttribute(o[s].nodeName, o[s].value);
                        return (
                            e.form &&
                            this.on(
                                e.form,
                    ...
                    this.options.disableEditing || e.getAttribute("data-disable-editing") || (e.setAttribute("contentEditable", !0), e.setAttribute("spellcheck", this.options.spellcheck)),
                    this.instanceHandleEditableKeydownEnter ||
                    ((e.getAttribute("data-disable-return") || e.getAttribute("data-disable-double-return")) &&
                        ((this.instanceHandleEditableKeydownEnter = p.bind(this)), this.subscribe("editableKeydownEnter", this.instanceHandleEditableKeydownEnter))),
                    ...
                    this.on(
                        ...
                        function (e) {
                            ...
                            t &&
                            (d.util.isMediumEditorElement(t) && 0 === t.children.length && !d.util.isBlockContainer(t) && this.options.ownerDocument.execCommand("formatBlock", !1, "p"),
                            !d.util.isKey(e, d.util.keyCode.ENTER) ||
                            d.util.isListItem(t) ||
                            d.util.isBlockContainer(t) ||
                            ("a" === t.nodeName.toLowerCase() ? this.options.ownerDocument.execCommand("unlink", !1, null) : e.shiftKey || e.ctrlKey || this.options.ownerDocument.execCommand("formatBlock", !1, "p")));
                        }.bind(this)
                    ),
                        (n = d.util.guid()),
            ...
            function w() {
                this.subscribe(
                    ...
                    function (e) {
                        var t = d.selection.getSelectionStart(this.options.ownerDocument);
                        "pre" === (t && t.nodeName.toLowerCase()) && (e.preventDefault(), d.util.insertHTMLCommand(this.options.ownerDocument, "    ")),
                        d.util.isListItem(t) && (e.preventDefault(), e.shiftKey ? this.options.ownerDocument.execCommand("outdent", !1, null) : this.options.ownerDocument.execCommand("indent", !1, null));
                    }.bind(this)
                ),
                ...
                this.subscribe(
                    ...
                    function (e) {
                        var t = (n = d.selection.getSelectionStart(this.options.ownerDocument)).textContent,
                            n = d.selection.getCaretOffsets(n);
                        (void 0 === t[n.left - 1] || "" === t[n.left - 1].trim() || (void 0 !== t[n.left] && "" === t[n.left].trim())) && e.preventDefault();
                    }.bind(this)
                ),
                this.instanceHandleEditableKeydownEnter ||
                ((this.options.disableReturn || this.options.disableDoubleReturn) && ((this.instanceHandleEditableKeydownEnter = p.bind(this)), this.subscribe("editableKeydownEnter", this.instanceHandleEditableKeydownEnter)));
            }
            function x() {
                (this.extensions = []),
                    Object.keys(this.options.extensions).forEach(function (e) {
                        "toolbar" !== e && this.options.extensions[e] && this.extensions.push(E(this.options.extensions[e], e, this));
                    }, this),
                function () {
                ...
                !n && C.call(this) && ((e = d.util.extend({}, this.options.toolbar, { allowMultiParagraphSelection: this.options.allowMultiParagraphSelection })), (n = new d.extensions.toolbar(e))),
            ...
            function T(e, t) {
                ...
                if ("fontSize" === e) return t.size && d.util.deprecated(".size option for fontSize command", ".value", "6.0.0"), (n = t.value || t.size), this.options.ownerDocument.execCommand("fontSize", !1, n);
                if ("fontName" === e) return t.name && d.util.deprecated(".name option for fontName command", ".value", "6.0.0"), (n = t.value || t.name), this.options.ownerDocument.execCommand("fontName", !1, n);
                ...
                if (/justify([A-Za-z]*)$/g.exec(e)) {
                    (o = this.options.ownerDocument.execCommand(e, !1, null)), (s = d.selection.getSelectedParentElement(d.selection.getSelectionRange(this.options.ownerDocument)));
                    return (
                        s &&
                        function (e) {
                            if (!e) return;
                            var n,
                                t = Array.prototype.slice.call(e.childNodes).filter(function (e) {
                            ...
                            (this.saveSelection(),
                                t.forEach(function (e) {
                                    var t;
                                    e.style.textAlign !== n || ((t = e.lastChild) && (d.util.unwrap(e, this.options.ownerDocument), (e = this.options.ownerDocument.createElement("BR")), t.parentNode.insertBefore(e, t.nextSibling)));
                                }, this),
                                (e.style.textAlign = n),
                ...
                return (n = t && t.value), this.options.ownerDocument.execCommand(e, !1, n);
            }
            return (
                (d.extensions = {}),
                    (function (e) {
                        ...
                        var h = {
                            ...
                            keyCode: { BACKSPACE: 8, TAB: 9, ENTER: 13, ESCAPE: 27, SPACE: 32, DELETE: 46, K: 75, M: 77, V: 86 },
                            ...
                            createLink: function (e, t, n, i) {
                                e = e.createElement("a");
                                return h.moveTextRangeIntoElement(t[0], t[t.length - 1], e), e.setAttribute("href", n), i && ("_blank" === i && e.setAttribute("rel", "noopener noreferrer"), e.setAttribute("target", i)), e;
                            },
                            findOrCreateMatchingTextNodes: function (e, t, n) {
                                for (var i = e.createTreeWalker(t, NodeFilter.SHOW_ALL, null, !1), o = [], s = 0, r = !1, a = null, l = null; null !== (a = i.nextNode()); )
                                    if (!(3 < a.nodeType))
                                        if (3 === a.nodeType) {
                                            if ((!r && n.start < s + a.nodeValue.length && ((r = !0), (l = h.splitStartNodeIfNeeded(a, n.start, s))), r && h.splitEndNodeIfNeeded(a, l, n.end, s), r && s === n.end)) break;
                                            if (r && s > n.end + 1) throw new Error("PerformLinking overshot the target!");
                                            r && o.push(l || a), (s += a.nodeValue.length), null !== l && ((s += l.nodeValue.length), i.nextNode()), (l = null);
                                        } else "img" === a.tagName.toLowerCase() && (!r && n.start <= s && (r = !0), r && o.push(a));
                                return o;
                            },
                            ...
                            splitByBlockElements: function (e) {
                                ...
                                for (var i = 0; i < e.childNodes.length; i++) {
                                    ...
                                    3 === o.nodeType ? t.push(o) : 1 === o.nodeType && (0 === o.querySelectorAll(n).length ? t.push(o) : (t = t.concat(d.util.splitByBlockElements(o))));
                                }
                                return t;
                            },
                            findAdjacentTextNodeWithContent: function (e, t, n) {
                                for (var i = !1, o = n.createNodeIterator(e, NodeFilter.SHOW_TEXT, null, !1), s = o.nextNode(); s; ) {
                                    if (s === t) i = !0;
                                    else if (i && 3 === s.nodeType && s.nodeValue && 0 < s.nodeValue.trim().length) break;
                                    s = o.nextNode();
                                }
                                return s;
                            },
                            findPreviousSibling: function (e) {
                                ...
                                for (var t = e.previousSibling; !t && !h.isMediumEditorElement(e.parentNode); ) t = (e = e.parentNode).previousSibling;
                                return t;
                            },
                            ...
                            throttle: function (n, i) {
                                function o() {
                                    (c = Date.now()), (l = null), (a = n.apply(s, r)), l || (s = r = null);
                                }
                                var s,
                                    r,
                                    a,
                                ...
                                return (
                                    i || 0 === i || (i = 50),
                                        function () {
                                            var e = Date.now(),
                                                t = i - (e - c);
                                            return (s = this), (r = arguments), t <= 0 || i < t ? (l && (clearTimeout(l), (l = null)), (c = e), (a = n.apply(s, r)), l || (s = r = null)) : (l = l || setTimeout(o, t)), a;
                                        }
                                );
                            },
                            ...
                            insertHTMLCommand: function (e, t) {
                                ...
                                if ((n = e.getSelection()).rangeCount) {
                                    if (((a = (n = n.getRangeAt(0)).commonAncestorContainer), h.isMediumEditorElement(a) && !a.firstChild)) n.selectNode(a.appendChild(e.createTextNode("")));
                                    else if ((3 === a.nodeType && 0 === n.startOffset && n.endOffset === a.nodeValue.length) || (3 !== a.nodeType && a.innerHTML === n.toString())) {
                                        for (; !h.isMediumEditorElement(a) && a.parentNode && 1 === a.parentNode.childNodes.length && !h.isMediumEditorElement(a.parentNode); ) a = a.parentNode;
                                        n.selectNode(a);
                                    }
                                    for (n.deleteContents(), (i = e.createElement("div")).innerHTML = t, o = e.createDocumentFragment(); i.firstChild; ) (s = i.firstChild), (r = o.appendChild(s));
                                    n.insertNode(o), r && ((n = n.cloneRange()).setStartAfter(r), n.collapse(!0), d.selection.selectRange(e, n)), (l = !0);
                                }
                                return e.execCommand.callListeners && e.execCommand.callListeners(c, l), l;
                            },
                            execFormatBlock: function (e, t) {
                                ...
                                if ((n && t === n.nodeName.toLowerCase() && (t = "p"), h.isIE && (t = "<" + t + ">"), n && "blockquote" === n.nodeName.toLowerCase())) {
                                    if (h.isIE && "<p>" === t) return e.execCommand("outdent", !1, t);
                            ...
                            addClassToAnchors: function (e, t) {
                                ...
                                if ("a" === e.nodeName.toLowerCase()) for (i = 0; i < o.length; i += 1) e.classList.add(o[i]);
                                    ...
                                    for (e = 0 === s.length ? ((t = h.getClosestTag(e, "a")) ? [t] : []) : s, n = 0; n < e.length; n += 1) for (i = 0; i < o.length; i += 1) e[n].classList.add(o[i]);
                                }
                            },
                            isListItem: function (e) {
                                if (!e) return !1;
                                if ("li" === e.nodeName.toLowerCase()) return !0;
                                for (var t = e.parentNode, n = t.nodeName.toLowerCase(); "li" === n || (!h.isBlockContainer(t) && "div" !== n); ) {
                                    if ("li" === n) return !0;
                            ...
                            cleanListDOM: function (e, t) {
                                ...
                                ("p" === (n = t.parentElement).parentElement.nodeName.toLowerCase() && (h.unwrap(n.parentElement, e), d.selection.moveCursor(e, t.firstChild, t.firstChild.textContent.length)));
                            },
                                ...
                                for (var i = t, o = null, s = !n; i !== e; ) {
                                    ...
                                    for (o && (s ? l.appendChild(o) : (r = o)), o = l; c; )
                                         var d = c.nextSibling,
                                             c =
                                                 c === i
                                                     ? (c.hasChildNodes() ? (c = c.cloneNode(!1)) : c.parentNode.removeChild(c), c.textContent && o.appendChild(c), s ? d : null)
                                                     : (c.parentNode.removeChild(c), (c.hasChildNodes() || c.textContent) && o.appendChild(c), d);
                            ...
                            moveTextRangeIntoElement: function (e, t, n) {
                                ...
                                return (
                                    r === e ? (r.parentNode.removeChild(r), u.appendChild(r)) : u.appendChild(h.splitOffDOMTree(r, e)),
                                        c.forEach(function (e) {
                                            e.parentNode.removeChild(e), u.appendChild(e);
                                        }),
                                        a === t ? (a.parentNode.removeChild(a), u.appendChild(a)) : u.appendChild(h.splitOffDOMTree(a, t, !0)),
                                        n.appendChild(u),
                                        a.parentNode === i ? i.insertBefore(n, a) : o ? i.insertBefore(n, o) : i.appendChild(n),
                                        n.hasChildNodes()
                                );
                            },
                            ...
                            findCommonRoot: function (e, t) {
                                for (var n = h.depthOfNode(e), i = h.depthOfNode(t), o = e, s = t; n !== i; ) i < n ? ((o = o.parentNode), --n) : ((s = s.parentNode), --i);
                                for (; o !== s; ) (o = o.parentNode), (s = s.parentNode);
                                return o;
                            },
                            isElementAtBeginningOfBlock: function (e) {
                                for (var t; !h.isBlockContainer(e) && !h.isMediumEditorElement(e); ) {
                                    for (t = e; (t = t.previousSibling); ) if (0 < (3 === t.nodeType ? t.nodeValue : t.textContent).length) return !1;
                                    e = e.parentNode;
                                }
                                return !0;
                            },
                            ...
                            isBlockContainer: function (e) {
                                return e && 3 !== e.nodeType && -1 !== h.blockContainerElementNames.indexOf(e.nodeName.toLowerCase());
                            },
                            ...
                            getTopBlockContainer: function (e) {
                                ...
                                return (
                                    h.traverseUp(e, function (e) {
                                        return h.isBlockContainer(e) && (t = e), !(t || !h.isMediumEditorElement(e)) && ((t = e), !0);
                                    }),
                                        t
                                );
                            },
                            getFirstSelectableLeafNode: function (e) {
                                ...
                                return (
                                    ...
                                    (e = h.traverseUp(e, function (e) {
                                        return -1 === h.emptyElementNames.indexOf(e.nodeName.toLowerCase());
                            ...
                            getFirstTextNode: function (e) {
                                return h.warn("getFirstTextNode is deprecated and will be removed in version 6.0.0"), h._getFirstTextNode(e);
                            },
                            ...
                            deprecatedMethod: function (e, t, n, i) {
                                h.deprecated(e, t, i), "function" == typeof this[t] && this[t].apply(this, n);
                            },
                            ...
                            unwrapTags: function (e, t) {
                                -1 !== t.indexOf(e.nodeName.toLowerCase()) && d.util.unwrap(e, document);
                            },
                    ...
                    (t.extend = function (e) {
                        ...
                        return (i.prototype = t.prototype), (n.prototype = new i()), e && d.util.extend(n.prototype, e), n;
                    }),
                    (t.prototype = {
                        init: function () {},
                        base: void 0,
                    ...
                    (e = {
                        findMatchingSelectionParent: function (e, t) {
                            t = t.getSelection();
                            return 0 !== t.rangeCount && ((t = t.getRangeAt(0).commonAncestorContainer), d.util.traverseUp(t, e));
                        },
                        ...
                        exportSelection: function (e, t) {
                            ...
                            return (
                                ...
                                ((n = (i = s.getRangeAt(0)).cloneRange()).selectNodeContents(e),
                                    ...
                                    (o = { start: (s = n.toString().length), end: s + i.toString().length }),
                                this.doesRangeStartWithImages(i, t) && (o.startsWithImage = !0),
                                (n = this.getTrailingImageCount(e, o, i.endContainer, i.endOffset)) && (o.trailingImageCount = n),
                                0 === s || (-1 !== (i = this.getIndexRelativeToAdjacentEmptyBlocks(t, e, i.startContainer, i.startOffset)) && (o.emptyBlocksIndex = i))),
                                    o
                            );
                        },
                        importSelection: function (e, t, n, i) {
                            if (e && t) {
                                ...
                                var s,
                                    ...
                                    m = !1,
                                    f = null;
                                for ((i || e.startsWithImage || void 0 !== e.emptyBlocksIndex) && (m = !0); !h && r; )
                                    if (3 < r.nodeType) r = a.pop();
                                    else {
                                        if (3 !== r.nodeType || d) {
                                            if (e.trailingImageCount && d && ("img" === r.nodeName.toLowerCase() && u++, u === e.trailingImageCount)) {
                                                for (var p = 0; r.parentNode.childNodes[p] !== r; ) p++;
                                                o.setEnd(r.parentNode, p + 1), (h = !0);
                                            }
                                            if (!h && 1 === r.nodeType) for (var g = r.childNodes.length - 1; 0 <= g; ) a.push(r.childNodes[g]), --g;
                                        } else
                                            (s = l + r.length),
                                            !c && e.start >= l && e.start <= s && (m || e.start < s ? (o.setStart(r, e.start - l), (c = !0)) : (f = r)),
                                            c && e.end >= l && e.end <= s && (e.trailingImageCount ? (d = !0) : (o.setEnd(r, e.end - l), (h = !0))),
                                                (l = s);
                                        h || (r = a.pop());
                                    }
                        ...
                        importSelectionMoveCursorPastAnchor: function (e, t) {
                            if (
                                ...
                                for (var n = t.startContainer, i = t.startContainer.parentNode; null !== i && "a" !== i.nodeName.toLowerCase(); ) i = i.childNodes[i.childNodes.length - 1] !== n ? null : (n = i).parentNode;
                                if (null !== i && "a" === i.nodeName.toLowerCase()) {
                                    for (var o = null, s = 0; null === o && s < i.parentNode.childNodes.length; s++) i.parentNode.childNodes[s] === i && (o = s);
                        ...
                        importSelectionMoveCursorPastBlocks: function (e, t, n, i) {
                            var o,
                                ...
                                t = i.startContainer,
                                a = 0;
                            for (n = n || 1, o = 3 === t.nodeType && d.util.isBlockContainer(t.previousSibling) ? t.previousSibling : d.util.getClosestBlockContainer(t); r.nextNode(); )
                                if (s) {
                                    if (((s = r.currentNode), ++a === n)) break;
                                    if (0 < s.textContent.length) break;
                                } else o === r.currentNode && (s = r.currentNode);
                            return (s = s || o), i.setStart(d.util.getFirstSelectableLeafNode(s), 0), i;
                        },
                        getIndexRelativeToAdjacentEmptyBlocks: function (e, t, n, i) {
                            ...
                            for (var s = d.util.getClosestBlockContainer(n), r = e.createTreeWalker(t, NodeFilter.SHOW_ELEMENT, c, !1), a = 0; r.nextNode(); ) {
                        ...
                        getTrailingImageCount: function (e, t, n, i) {
                            ...
                            for (var s, r = e, a = [], l = 0, c = !1, d = !1, u = !1, h = 0; !u && r; )
                                if (3 < r.nodeType) r = a.pop();
                                else {
                                    if (3 !== r.nodeType || d) {
                                        if (("img" === r.nodeName.toLowerCase() && h++, r === o)) u = !0;
                                        else if (1 === r.nodeType) for (var m = r.childNodes.length - 1; 0 <= m; ) a.push(r.childNodes[m]), --m;
                                    } else (h = 0), (s = l + r.length), !c && t.start >= l && t.start <= s && (c = !0), c && t.end >= l && t.end <= s && (d = !0), (l = s);
                                    u || (r = a.pop());
                                }
                            return h;
                        },
                        selectionContainsContent: function (e) {
                            ...
                            return !(!e || !("img" === e.nodeName.toLowerCase() || (1 === e.nodeType && e.querySelector("img"))));
                        },
                        selectionInContentEditableFalse: function (e) {
                            var n,
                                e = this.findMatchingSelectionParent(function (e) {
                                    ...
                                    return "true" === t && (n = !0), "#text" !== e.nodeName && "false" === t;
                                }, e);
                            return !n && e;
                        },
                        ...
                        getCaretOffsets: function (e, t) {
                            var n = (t = t || window.getSelection().getRangeAt(0)).cloneRange(),
                                i = t.cloneRange();
                            return n.selectNodeContents(e), n.setEnd(t.endContainer, t.endOffset), i.selectNodeContents(e), i.setStart(t.endContainer, t.endOffset), { left: n.toString().length, right: i.toString().length };
                        },
                        ...
                        getSelectedParentElement: function (e) {
                            return e
                                ? this.rangeSelectsSingleNode(e) && 3 !== e.startContainer.childNodes[e.startOffset].nodeType
                        ...
                        getSelectedElements: function (e) {
                            var t,
                                n,
                                i = e.getSelection();
                            if (!i.rangeCount || i.isCollapsed || !i.getRangeAt(0).commonAncestorContainer) return [];
                            if (3 !== (e = i.getRangeAt(0)).commonAncestorContainer.nodeType)
                                return [].filter.call(e.commonAncestorContainer.getElementsByTagName("*"), function (e) {
                                    return "function" != typeof i.containsNode || i.containsNode(e, !0);
                                });
                            for (t = [], n = e.commonAncestorContainer; n.parentNode && 1 === n.parentNode.childNodes.length; ) t.push(n.parentNode), (n = n.parentNode);
                            return t;
                        },
                    ...
                    (u.prototype = {
                        ...
                        detachDOMEvent: function (e, t, n, i) {
                            ...
                            ((e = d.util.isElement(e) || -1 < [s, r].indexOf(e) ? [e] : e),
                                Array.prototype.forEach.call(
                                    e,
                                    function (e) {
                                        -1 !== (o = this.indexOfListener(e, t, n, i)) && (o = this.events.splice(o, 1)[0])[0].removeEventListener(o[1], o[2], o[3]);
                                    }.bind(this)
                                ));
                        },
                        indexOfListener: function (e, t, n, i) {
                            for (var o, s = 0, r = this.events.length; s < r; s += 1) if ((o = this.events[s])[0] === e && o[1] === t && o[2] === n && o[3] === i) return s;
                            return -1;
                        },
                        ...
                        attachAllEventsToElement: function (t) {
                            this.listeners.editableInput && (this.contentCache[t.getAttribute("medium-editor-index")] = t.innerHTML),
                            this.eventsCache &&
                        ...
                        detachExecCommand: function () {
                            ...
                            (-1 !== (e = t.execCommand.listeners.indexOf(this.execCommandListener)) && t.execCommand.listeners.splice(e, 1), t.execCommand.listeners.length || this.unwrapExecCommand());
                        },
                        ...
                        updateFocus: function (t, e) {
                            ...
                            i && "click" === e.type && this.lastMousedownTarget && (d.util.isDescendant(i, this.lastMousedownTarget, !0) || l(this.base.extensions, this.lastMousedownTarget)) && (n = i),
                            n ||
                            this.base.elements.some(function (e) {
                                return !n && d.util.isDescendant(e, t, !0) && (n = e), !!n;
                            }, this);
                            var o = !d.util.isDescendant(i, t, !0) && !l(this.base.extensions, t);
                            n !== i && (i && o && (i.removeAttribute("data-medium-focused"), this.triggerCustomEvent("blur", e, i)), n && (n.setAttribute("data-medium-focused", !0), this.triggerCustomEvent("focus", e, n))),
                            o && this.triggerCustomEvent("externalInteraction", e);
                        },
                        updateInput: function (e, t) {
                            var n, i;
                            this.contentCache && ((n = e.getAttribute("medium-editor-index")), (i = e.innerHTML) !== this.contentCache[n] && this.triggerCustomEvent("editableInput", t, e), (this.contentCache[n] = i));
                        },
                        ...
                        handleInput: function (e) {
                            ...
                            0 == document.querySelector("#" + this.base.elements[0].id).innerText.length && (this.base.selectElement(document.querySelector("#" + this.base.elements[0].id)), this.base.setContent("<p><br></p>"));
                        },
                            ...
                            return (
                                this.triggerCustomEvent("editableKeydown", e, e.currentTarget),
                                    d.util.isKey(e, d.util.keyCode.SPACE)
                                        ? this.triggerCustomEvent("editableKeydownSpace", e, e.currentTarget)
                                        : d.util.isKey(e, d.util.keyCode.ENTER) || (e.ctrlKey && d.util.isKey(e, d.util.keyCode.M))
                                            ? this.triggerCustomEvent("editableKeydownEnter", e, e.currentTarget)
                                            : d.util.isKey(e, d.util.keyCode.TAB)
                                                ? this.triggerCustomEvent("editableKeydownTab", e, e.currentTarget)
                                                : d.util.isKey(e, [d.util.keyCode.DELETE, d.util.keyCode.BACKSPACE])
                                                    ? this.triggerCustomEvent("editableKeydownDelete", e, e.currentTarget)
                                                    : void 0
                            );
                        },
                    }),
                    ...
                    ((n = d.Extension.extend({
                        ...
                        constructor: function (e) {
                            n.isBuiltInButton(e) ? d.Extension.call(this, this.defaults[e]) : d.Extension.call(this, e);
                        },
                        init: function () {
                            d.Extension.prototype.init.apply(this, arguments), (this.button = this.createButton()), this.on(this.button, "click", this.handleClick.bind(this));
                        },
                        getButton: function () {
                            return this.button;
                        },
                        ...
                        createButton: function () {
                            ...
                            return (
                                ...
                                n && (t.setAttribute("title", n), t.setAttribute("aria-label", n)),
                                this.attrs &&
                        ...
                        handleClick: function (e) {
                            ...
                            ((t = document.querySelector("#" + this.base.elements[0].id)),
                                this.base.posSaved ? this.base.restoreSelection() : this.base.selectElement(t),
                                this.execAction(n),
                                ((e = d.selection.getSelectionRange(this.document)).startOffset != e.endOffset ? unwrapReWrap : removeAttrs)(t),
                            (e = document.querySelector('textarea[medium-editor-textarea-id="' + t.getAttribute("medium-editor-textarea-id") + '"]')) && (e.value = t.innerHTML.trim()),
                            "superscript" == n && (this.isActive() ? this.setInactive() : this.setActive()));
                        },
                        isActive: function () {
                        ...
                        isAlreadyApplied: function (e) {
                            ...
                            return !1 === this.knownState || !0 === this.knownState
                                ? this.knownState
                                : (i && 0 < i.length && (n = -1 !== i.indexOf(e.nodeName.toLowerCase())),
                                !n &&
                                this.style &&
                                ((i = this.style.value.split("|")),
                                    (t = this.window.getComputedStyle(e, null).getPropertyValue(this.style.prop)),
                                    i.forEach(function (e) {
                                        this.knownState || (!(n = -1 !== t.indexOf(e)) && "text-decoration" === this.style.prop) || (this.knownState = n);
                                    }, this)),
                                    n);
                        },
                    })).isBuiltInButton = function (e) {
                        return "string" == typeof e && d.extensions.button.prototype.defaults.hasOwnProperty(e);
                    }),
                    (d.extensions.button = n),
                    (d.extensions.button.prototype.defaults = {
                        bold: { name: "bold", action: "bold", aria: "bold", tagNames: ["b", "strong"], style: { prop: "font-weight", value: "700|bold" }, useQueryState: !0, contentDefault: "<b>B</b>", contentFA: '<i class="fa fa-bold"></i>' },
                        italic: {
                            name: "italic",
                            action: "italic",
                            aria: "italic",
                        ...
                        superscript: { name: "superscript", action: "superscript", aria: "спойлер", tagNames: ["sup"], contentDefault: "<b>спойлер</b>", contentFA: '<i class="fa fa-superscript"></i>' },
                        subscript: { name: "subscript", action: "subscript", aria: "subscript", tagNames: ["sub"], contentDefault: "<b>x<sub>1</sub></b>", contentFA: '<i class="fa fa-subscript"></i>' },
                        image: { name: "image", action: "image", aria: "image", tagNames: ["img"], contentDefault: "<b>image</b>", contentFA: '<i class="fa fa-picture-o"></i>' },
                        html: { name: "html", action: "html", aria: "evaluate html", tagNames: ["iframe", "object"], contentDefault: "<b>html</b>", contentFA: '<i class="fa fa-code"></i>' },
                        orderedlist: { name: "orderedlist", action: "insertorderedlist", aria: "ordered list", tagNames: ["ol"], useQueryState: !0, contentDefault: "<b>1.</b>", contentFA: '<i class="fa fa-list-ol"></i>' },
                        unorderedlist: { name: "unorderedlist", action: "insertunorderedlist", aria: "unordered list", tagNames: ["ul"], useQueryState: !0, contentDefault: "<b>&bull;</b>", contentFA: '<i class="fa fa-list-ul"></i>' },
                        indent: { name: "indent", action: "indent", aria: "indent", tagNames: [], contentDefault: "<b>&rarr;</b>", contentFA: '<i class="fa fa-indent"></i>' },
                        outdent: { name: "outdent", action: "outdent", aria: "outdent", tagNames: [], contentDefault: "<b>&larr;</b>", contentFA: '<i class="fa fa-outdent"></i>' },
                        justifyCenter: {
                            name: "justifyCenter",
                        ...
                        justifyLeft: { name: "justifyLeft", action: "justifyLeft", aria: "left justify", tagNames: [], style: { prop: "text-align", value: "left" }, contentDefault: "<b>L</b>", contentFA: '<i class="fa fa-align-left"></i>' },
                        justifyRight: {
                            name: "justifyRight",
                            action: "justifyRight",
                            aria: "right justify",
                        ...
                        removeFormat: { name: "removeFormat", aria: "remove formatting", action: "removeFormat", contentDefault: "<b>X</b>", contentFA: '<i class="fa fa-eraser"></i>' },
                        quote: { name: "quote", action: "append-blockquote", aria: "blockquote", tagNames: ["blockquote"], contentDefault: "<b>&ldquo;</b>", contentFA: '<i class="fa fa-quote-right"></i>' },
                        pre: { name: "pre", action: "append-pre", aria: "preformatted text", tagNames: ["pre"], contentDefault: "<b>0101</b>", contentFA: '<i class="fa fa-code fa-lg"></i>' },
                        h1: { name: "h1", action: "append-h1", aria: "header type one", tagNames: ["h1"], contentDefault: "<b>H1</b>", contentFA: '<i class="fa fa-header"><sup>1</sup>' },
                        h2: { name: "h2", action: "append-h2", aria: "header type two", tagNames: ["h2"], contentDefault: "<b>H2</b>", contentFA: '<i class="fa fa-header"><sup>2</sup>' },
                        h3: { name: "h3", action: "append-h3", aria: "header type three", tagNames: ["h3"], contentDefault: "<b>H3</b>", contentFA: '<i class="fa fa-header"><sup>3</sup>' },
                        h4: { name: "h4", action: "append-h4", aria: "header type four", tagNames: ["h4"], contentDefault: "<b>H4</b>", contentFA: '<i class="fa fa-header"><sup>4</sup>' },
                        h5: { name: "h5", action: "append-h5", aria: "header type five", tagNames: ["h5"], contentDefault: "<b>H5</b>", contentFA: '<i class="fa fa-header"><sup>5</sup>' },
                        h6: { name: "h6", action: "append-h6", aria: "header type six", tagNames: ["h6"], contentDefault: "<b>H6</b>", contentFA: '<i class="fa fa-header"><sup>6</sup>' },
                    }),
                    ...
                    (e = d.extensions.form.extend({
                        ...
                        init: function () {
                            d.extensions.form.prototype.init.apply(this, arguments), this.subscribe("editableKeydown", this.handleKeydown.bind(this));
                        },
                        handleClick: function (e) {
                            e.preventDefault(), e.stopPropagation();
                            e = d.selection.getSelectionRange(this.document);
                            return "a" === e.startContainer.nodeName.toLowerCase() || "a" === e.endContainer.nodeName.toLowerCase() || d.util.getClosestTag(d.selection.getSelectedParentElement(e), "a")
                                ? this.execAction("unlink")
                                : (this.isDisplayed() || this.showForm(), !1);
                        },
                        handleKeydown: function (e) {
                            d.util.isKey(e, d.util.keyCode.K) && d.util.isMetaCtrlKey(e) && !e.shiftKey && this.handleClick(e);
                        },
                        getForm: function () {
                        ...
                        getTemplate: function () {
                            ...
                            return (
                                e.push('<a href="#" class="medium-editor-toolbar-save">', "fontawesome" === this.getEditorOption("buttonLabels") ? '<i class="fa fa-check"></i>' : this.formSaveLabel, "</a>"),
                        ...
                        hideForm: function () {
                            d.extensions.form.prototype.hideForm.apply(this), (this.getInput().value = "");
                        },
                        showForm: function (e) {
                            var t = this.getInput(),
                            ...
                            i && ((e = e.buttonClass ? e.buttonClass.split(" ") : []), (i.checked = -1 !== e.indexOf(this.customClassOption)));
                        },
                        destroy: function () {
                        ...
                        ensureEncodedParam: function (e) {
                            var t = e.split("="),
                                e = t[0],
                                t = t[1];
                            return e + (void 0 === t ? "" : "=" + this.ensureEncodedUriComponent(t));
                        },
                        ...
                        checkLinkFormat: function (e) {
                            ...
                            return /^\+?\s?\(?(?:\d\s?\-?\)?){3,20}$/.test(e)
                                ? "tel:" + e
                                : (t || (!(t = o.split("/")[0]).match(/.+(\.|:).+/) && "localhost" !== t) || (n = "http://"),
                                n + this.ensureEncodedUri(o) + (void 0 === s ? "" : "?" + this.ensureEncodedQuery(s)) + (void 0 === i ? "" : "#" + i));
                        },
                        ...
                        handleTextboxKeyup: function (e) {
                            if (e.keyCode === d.util.keyCode.ENTER) return e.preventDefault(), void this.doFormSave();
                            e.keyCode === d.util.keyCode.ESCAPE && (e.preventDefault(), this.doFormCancel());
                        },
                    ...
                    (e = d.Extension.extend({
                        ...
                        showPreview: function (e) {
                            return (
                                !(!this.anchorPreview.classList.contains("medium-editor-anchor-preview-active") && !e.getAttribute("data-disable-preview")) ||
                                (this.previewValueSelector &&
                                ((this.anchorPreview.querySelector(this.previewValueSelector).textContent = e.attributes.href.value), (this.anchorPreview.querySelector(this.previewValueSelector).href = e.attributes.href.value)),
                        ...
                        positionPreview: function (e) {
                            ...
                            var t,
                                ...
                                l = -1 < ["absolute", "fixed"].indexOf(window.getComputedStyle(a).getPropertyValue("position")),
                                c = {},
                            ...
                            e && ((s = e.diffLeft), (r = e.diffTop)),
                                ...
                                a < d
                                    ? ((this.anchorPreview.style.left = s + d + "px"), (this.anchorPreview.style.right = "initial"))
                                    : n - a < d
                                        ? ((this.anchorPreview.style.left = "auto"), (this.anchorPreview.style.right = 0))
                                        : ((this.anchorPreview.style.left = s + a + "px"), (this.anchorPreview.style.right = "initial"));
                        },
                        ...
                        handleClick: function (e) {
                            ...
                            (e.preventDefault(),
                                ...
                                this.base.delay(
                                    function () {
                                        var e;
                                        n && ((e = { value: n.attributes.href.value, target: n.getAttribute("target"), buttonClass: n.getAttribute("class") }), t.showForm(e), (n = null));
                                    }.bind(this)
                                )),
                                this.hidePreview();
                        },
                        ...
                        handleEditableMouseover: function (e) {
                            ...
                            if (!1 !== t) {
                                if (!this.showOnEmptyLinks && (!/href=["']\S+["']/.test(t.outerHTML) || /href=["']#\S+["']/.test(t.outerHTML))) return !0;
                                e = this.base.getExtensionByName("toolbar");
                                if (!this.showWhenToolbarIsVisible && e && e.isDisplayed && e.isDisplayed()) return !0;
                                this.activeAnchor && this.activeAnchor !== t && this.detachPreviewHandlers(),
                        ...
                        detachPreviewHandlers: function () {
                            ...
                            this.activeAnchor && (this.off(this.activeAnchor, "mouseover", this.instanceHandlePreviewMouseover), this.off(this.activeAnchor, "mouseout", this.instanceHandlePreviewMouseout))),
                                this.hidePreview(),
                    ...
                    (function () {
                        ...
                        var e = d.Extension.extend({
                            ...
                            onKeypress: function (t) {
                                ...
                                (d.util.isKey(t, [d.util.keyCode.SPACE, d.util.keyCode.ENTER]) &&
                            ...
                            performLinking: function (e) {
                                var t = d.util.splitByBlockElements(e),
                                    n = !1;
                                0 === t.length && (t = [e]);
                                for (var i = 0; i < t.length; i++) (n = this.removeObsoleteAutoLinkSpans(t[i]) || n), (n = this.performLinkingWithinElement(t[i]) || n);
                                return this.base.events.updateInput(e, { target: e, currentTarget: e }), n;
                            },
                            removeObsoleteAutoLinkSpans: function (e) {
                                if (!e || 3 === e.nodeType) return !1;
                                for (var t = e.querySelectorAll('span[data-auto-link="true"]'), n = !1, i = 0; i < t.length; i++) {
                                    var o,
                                        s = t[i].textContent;
                                    ...
                                    ((n = !0),
                                        ...
                                        t[i].getAttribute("data-href") === o
                                            ? ((o = s.length - o.length), (o = d.util.splitOffDOMTree(t[i], this.splitTextBeforeEnd(t[i], o))), t[i].parentNode.insertBefore(o, t[i].nextSibling))
                                            : d.util.unwrap(t[i], this.document));
                                }
                                return n;
                            },
                            splitTextBeforeEnd: function (e, t) {
                                for (var n, i, o, s = this.document.createTreeWalker(e, NodeFilter.SHOW_TEXT, null, !1), r = !0; r; ) r = null !== s.lastChild();
                                for (; 0 < t && null !== o; ) (i = (n = s.currentNode).nodeValue).length > t ? ((o = n.splitText(i.length - t)), (t = 0)) : ((o = s.previousNode()), (t -= i.length));
                                return o;
                            },
                            performLinkingWithinElement: function (e) {
                                for (var t = this.findLinkableText(e), n = 0; n < t.length; n++) {
                                    var i = d.util.findOrCreateMatchingTextNodes(this.document, e, t[n]);
                            ...
                            findLinkableText: function (e) {
                                for (var t = e.textContent, n = null, i = []; null !== (n = a.exec(t)); ) {
                                    var o = n.index + n[0].length;
                                    !((0 !== n.index && -1 === s.indexOf(t[n.index - 1])) || (o !== t.length && -1 === s.indexOf(t[o]))) &&
                                    (-1 !== n[0].indexOf("/") || r.test(n[0].split(".").pop().split("?").shift())) &&
                            ...
                            createAutoLink: function (e, t) {
                                ...
                                var n = d.util.createLink(this.document, e, t, this.getEditorOption("targetBlank") ? "_blank" : null),
                                    i = this.document.createElement("span");
                                for (i.setAttribute("data-auto-link", "true"), i.setAttribute("data-href", t), n.insertBefore(i, n.firstChild); 1 < n.childNodes.length; ) i.appendChild(n.childNodes[1]);
                            },
                        });
                    ...
                    (e = d.Extension.extend({
                        ...
                        allowedTypes: ["image"],
                        init: function () {
                            d.Extension.prototype.init.apply(this, arguments), this.subscribe("editableDrag", this.handleDrag.bind(this)), this.subscribe("editableDrop", this.handleDrop.bind(this));
                        },
                            ...
                            ((t = new FileReader()).readAsDataURL(e),
                                t.addEventListener(
                                    ...
                                    function (e) {
                                        ...
                                        (t.src = e.target.result), d.util.insertHTMLCommand(this.document, t.outerHTML);
                                    }.bind(this)
                                ));
                        },
                    })),
                        ...
                        handleKeydown: function (t) {
                            ...
                            ((n = d.util.isMetaCtrlKey(t)),
                                ...
                                this.keys[e].forEach(function (e) {
                                    ...
                                    (t.preventDefault(), t.stopPropagation(), "function" == typeof e.command ? e.command.apply(this) : !1 !== e.command && this.execAction(e.command));
                                }, this));
                        },
                    })),
                    ...
                    (e = d.extensions.form.extend({
                        ...
                        handleClick: function (e) {
                            return e.preventDefault(), e.stopPropagation(), this.isDisplayed() || ((e = this.document.queryCommandValue("fontName") + ""), this.showForm(e)), !1;
                        },
                        getForm: function () {
                            return this.form || (this.form = this.createForm()), this.form;
                        },
                        ...
                        createForm: function () {
                            ...
                            return (
                                (i.className = "medium-editor-toolbar-select"),
                                    ...
                                    (s.innerHTML = "fontawesome" === this.getEditorOption("buttonLabels") ? '<i class="fa fa-check"></i>' : "&#10003;"),
                                    n.appendChild(s),
                        ...
                        clearFontName: function () {
                            d.selection.getSelectedElements(this.document).forEach(function (e) {
                                "font" === e.nodeName.toLowerCase() && e.hasAttribute("face") && e.removeAttribute("face");
                            });
                        },
                        handleFontChange: function () {
                            var e = this.getSelect().value;
                            "" === e ? this.clearFontName() : this.execAction("fontName", { value: e });
                        },
                        handleFormClick: function (e) {
                            e.stopPropagation();
                        },
                    ...
                    (e = d.extensions.form.extend({
                        ...
                        handleClick: function (e) {
                            return e.preventDefault(), e.stopPropagation(), this.isDisplayed() || ((e = this.document.queryCommandValue("fontSize") + ""), this.showForm(e)), !1;
                        },
                        getForm: function () {
                            return this.form || (this.form = this.createForm()), this.form;
                        },
                        ...
                        showForm: function (e) {
                            var t = this.getInput();
                            this.base.c(), this.hideToolbarDefaultActions(), (this.getForm().style.display = "block"), this.setToolbarPosition(), (t.value = e || ""), t.focus();
                        },
                        destroy: function () {
                            if (!this.form) return !1;
                            this.form.parentNode && this.form.parentNode.removeChild(this.form), delete this.form;
                        ...
                        handleSliderChange: function () {
                            ...
                            "4" === e ? this.clearFontSize() : this.execAction("fontSize", { value: e });
                        },
                        handleFormClick: function (e) {
                            e.stopPropagation();
                        },
                    ...
                    (e = d.Extension.extend({
                        ...
                        handlePaste: function (e, t) {
                            ...
                            ((n = (i = f(e, this.window, this.document))["text/html"]),
                                (i = i["text/plain"]),
                            this.window.clipboardData && void 0 === e.clipboardData && !n && (n = i),
                        ...
                        doPaste: function (e, t, n) {
                            ...
                            if (t) {
                                if (this.getEditorOption("disableReturn") || (n && n.getAttribute("data-disable-return"))) s = d.util.htmlEntities(t);
                                else if (1 < (i = t.split(/[\r\n]+/g)).length) for (o = 0; o < i.length; o += 1) "" !== i[o] && (s += "<p>" + d.util.htmlEntities(i[o]) + "</p>");
                        ...
                        handlePasteBinPaste: function (e) {
                            if (e.defaultPrevented) this.removePasteBin();
                                ...
                                var t = f(e, this.window, this.document),
                                    ...
                                    i = t["text/plain"],
                                    o = r;
                                if (!this.cleanPastedHTML || n) return e.preventDefault(), this.removePasteBin(), this.doPaste(n, i, o), void this.trigger("editablePaste", { currentTarget: o, target: o }, o);
                                setTimeout(
                                    function () {
                                        this.cleanPastedHTML && (n = this.getPasteBinHtml()), this.removePasteBin(), this.doPaste(n, i, o), this.trigger("editablePaste", { currentTarget: o, target: o }, o);
                                    }.bind(this),
                                    0
                                );
                            }
                        ...
                        handleKeydown: function (e, t) {
                            d.util.isKey(e, d.util.keyCode.V) && d.util.isMetaCtrlKey(e) && (e.stopImmediatePropagation(), this.removePasteBin(), this.createPasteBin(t));
                        },
                        createPasteBin: function (e) {
                            var t = d.selection.getSelectionRange(this.document),
                                n = this.window.pageYOffset;
                            (r = e),
                            t && ((e = t.getClientRects()).length ? (n += e[0].top) : void 0 !== t.startContainer.getBoundingClientRect ? (n += t.startContainer.getBoundingClientRect().top) : (n += t.getBoundingClientRect().top)),
                                (s = t);
                            t = this.document.createElement("div");
                            (t.id = this.pasteBinId = "medium-editor-pastebin-" + +Date.now()),
                                t.setAttribute("style", "border: 1px red solid; position: absolute; top: " + n + "px; width: 10px; height: 10px; overflow: hidden; opacity: 0"),
                        ...
                        removePasteBin: function () {
                            null !== s && (d.selection.selectRange(this.document, s), (s = null)), null !== r && (r = null);
                            var e = this.getPasteBin();
                            e && e && (this.off(e, "focus", m), this.off(e, "focusin", m), this.off(e, "focusout", m), this.off(e, "paste", this.boundHandlePaste), e.parentElement.removeChild(e));
                        },
                        ...
                        cleanPaste: function (e) {
                            ...
                            for ((i = this.document.createElement("div")).innerHTML = "<p>" + e.split("<br><br>").join("</p><p>") + "</p>", t = i.querySelectorAll("a,p,div,br"), s = 0; s < t.length; s += 1)
                                switch ((((n = t[s]).innerHTML = n.innerHTML.replace(/\n/gi, " ")), n.nodeName.toLowerCase())) {
                                    case "p":
                                    case "div":
                        ...
                        pasteHTML: function (e, t) {
                            t = d.util.defaults({}, t, { cleanAttrs: this.cleanAttrs, cleanTags: this.cleanTags, unwrapTags: this.unwrapTags });
                            var n,
                                i,
                                o,
                                s = this.document.createDocumentFragment();
                            for (s.appendChild(this.document.createElement("body")), (s = s.querySelector("body")).innerHTML = e, this.cleanupSpans(s), n = s.querySelectorAll("*"), o = 0; o < n.length; o += 1)
                                "a" === (i = n[o]).nodeName.toLowerCase() && this.getEditorOption("targetBlank") && d.util.setTargetBlank(i),
                                    d.util.cleanupAttrs(i, t.cleanAttrs),
                                    d.util.cleanupTags(i, t.cleanTags),
                                    d.util.unwrapTags(i, t.unwrapTags);
                            d.util.insertHTMLCommand(this.document, s.innerHTML.replace(/&nbsp;/g, " "));
                        },
                        ...
                        filterLineBreak: function (e) {
                            (this.isCommonBlock(e.previousElementSibling) ||
                                (this.isCommonBlock(e.parentNode) && (e.parentNode.firstChild === e || e.parentNode.lastChild === e)) ||
                                (e.parentNode && 1 === e.parentNode.childElementCount && "" === e.parentNode.textContent)) &&
                        ...
                        cleanupSpans: function (e) {
                            for (
                                ...
                                (t = i[s]),
                                    (n = this.document.createElement(t.classList.contains("bold") ? "b" : "i")),
                                    t.classList.contains("bold") && t.classList.contains("italic") ? (n.innerHTML = "<i>" + t.innerHTML + "</i>") : (n.innerHTML = t.innerHTML),
                    ...
                    (e = d.Extension.extend({
                        ...
                        hideOnClick: !0,
                        init: function () {
                            d.Extension.prototype.init.apply(this, arguments), this.initPlaceholders(), this.attachEventHandlers();
                        },
                        ...
                        showPlaceholder: function (e) {
                            ...
                            (d.util.isFF && 0 === e.childNodes.length
                                ? (e.classList.add("medium-editor-placeholder-relative"), e.classList.remove("medium-editor-placeholder"))
                                : (e.classList.add("medium-editor-placeholder"), e.classList.remove("medium-editor-placeholder-relative")));
                        },
                    ...
                    (e = d.Extension.extend({
                        ...
                        init: function () {
                            d.Extension.prototype.init.apply(this, arguments), this.initThrottledMethods(), (this.relativeContainer || this.getEditorOption("elementsContainer")).appendChild(this.getToolbarElement());
                        },
                        ...
                        createToolbar: function () {
                            ...
                            (t.id = "medium-editor-toolbar-" + this.getEditorId()),
                                ...
                                this.static ? (t.className += " static-toolbar") : this.relativeContainer ? (t.className += " medium-editor-relative-toolbar") : (t.className += " medium-editor-stalker-toolbar");
                            var e = this.document.createElement("div"),
                                n = this.document.createElement("i");
                            return (
                                (n.innerHTML = "Комментарий, содержащий мат или оскорбления других участников, будет удален!"),
                            ...
                            return (
                                (i.id = "medium-editor-toolbar-actions" + this.getEditorId()),
                                    ...
                                    this.buttons.forEach(function (e) {
                                        (n = "string" == typeof e ? ((t = e), null) : ((t = e.name), e)),
                                        (t = this.base.addBuiltInExtension(t, n)) &&
                                        "function" == typeof t.getButton &&
                                        ((n = t.getButton(this.base)), (t = this.document.createElement("li")), d.util.isElement(n) ? t.appendChild(n) : (t.innerHTML = n), i.appendChild(t));
                                    }, this),
                                0 < (e = i.querySelectorAll("button")).length && (e[0].classList.add(this.firstButtonClass), e[e.length - 1].classList.add(this.lastButtonClass)),
                                    i
                            );
                        },
                        destroy: function () {
                        ...
                        handleDocumentMouseup: function (e) {
                            if (e && e.target && d.util.isDescendant(this.getToolbarElement(), e.target)) return !1;
                            this.checkState();
                        },
                        ...
                        multipleBlockElementsSelected: function () {
                            var e = new RegExp("<(" + d.util.blockContainerElementNames.join("|") + ")[^>]*>", "g"),
                                e = d.selection
                        ...
                        modifySelection: function () {
                            ...
                            if (this.standardizeSelectionStart && e.startContainer.nodeValue && e.startOffset === e.startContainer.nodeValue.length) {
                                var t = d.util.findAdjacentTextNodeWithContent(d.selection.getSelectionElement(this.window), e.startContainer, this.document);
                                if (t) {
                                    for (var n = 0; 0 === t.nodeValue.substr(n, 1).trim().length; ) n += 1;
                                    e = d.selection.select(this.document, t, n, e.endContainer, e.endOffset);
                                }
                            }
                        },
                        checkState: function () {
                            if (!this.base.preventSelectionUpdates) {
                                if (!this.base.getFocusedElement() || d.selection.selectionInContentEditableFalse(this.window)) return this.hideToolbar();
                                var e = d.selection.getSelectionElement(this.window);
                                return !e || -1 === this.getEditorElements().indexOf(e) || e.getAttribute("data-disable-toolbar")
                                    ? this.hideToolbar()
                                    : this.updateOnEmptySelection && this.static
                                        ? this.showAndUpdateToolbar()
                                        : !d.selection.selectionContainsContent(this.document) || (!1 === this.allowMultiParagraphSelection && this.multipleBlockElementsSelected())
                                            ? this.hideToolbar()
                        ...
                        checkActiveButtons: function () {
                            function e(e) {
                                "function" == typeof e.checkState
                                    ? e.checkState(n)
                                    : "function" == typeof e.isActive && "function" == typeof e.isAlreadyApplied && "function" == typeof e.setActive && !e.isActive() && e.isAlreadyApplied(n) && e.setActive();
                            }
                            var t,
                                n,
                                i = [],
                            ...
                            if (
                                o &&
                                (this.forEachExtension(function (e) {
                                    "function" != typeof e.queryCommandState || null === (t = e.queryCommandState()) ? i.push(e) : t && "function" == typeof e.setActive && e.setActive();
                                }),
                                ...
                                for (; n && (i.forEach(e), !d.util.isMediumEditorElement(n)); ) n = n.parentNode;
                        },
                        ...
                        setToolbarPosition: function () {
                            ...
                            (this.showToolbar(), this.relativeContainer || (this.static ? this.positionStaticToolbar(e) : this.positionToolbar(t)), this.trigger("positionedToolbar", {}, this.base.getFocusedElement()));
                        },
                        positionStaticToolbar: function (e) {
                            this.getToolbarElement().style.left = "0";
                            var t,
                                n = (this.document.documentElement && this.document.documentElement.scrollTop) || this.document.body.scrollTop,
                            ...
                            switch (
                                (this.sticky
                                    ? n > r + e.offsetHeight - l - this.stickyTopOffset
                                        ? ((o.style.top = r + e.offsetHeight - l + "px"), o.classList.remove("medium-editor-sticky-toolbar"))
                                        : n > r - l - this.stickyTopOffset
                                            ? (o.classList.add("medium-editor-sticky-toolbar"), (o.style.top = this.stickyTopOffset + "px"))
                                            : (o.classList.remove("medium-editor-sticky-toolbar"), (o.style.top = r - l + "px"))
                                    : (o.style.top = r - l + "px"),
                                    this.align)
                                ) {
                                case "left":
                            ...
                            t < 0 ? (t = 0) : i < t + c && (t = i - Math.ceil(c) - 1), (o.style.left = t + "px");
                        },
                        positionToolbar: function (e) {
                            (this.getToolbarElement().style.left = "0"), (this.getToolbarElement().style.right = "initial");
                            var t = e.getRangeAt(0),
                                n = t.getBoundingClientRect();
                            (n && (0 !== n.height || 0 !== n.width || t.startContainer !== t.endContainer)) ||
                            (n = (1 === t.startContainer.nodeType && t.startContainer.querySelector("img") ? t.startContainer.querySelector("img") : t.startContainer).getBoundingClientRect());
                            var i,
                                ...
                                t = -1 < ["absolute", "fixed"].indexOf(window.getComputedStyle(e).getPropertyValue("position")),
                                c = {},
                                d = {};
                            t
                                ...
                                (c.top += n.top - r),
                                n.top < 50
                                    ? (s.classList.add("medium-toolbar-arrow-over"), s.classList.remove("medium-toolbar-arrow-under"), (c.top += 50 + n.height - this.diffTop))
                                    : (s.classList.add("medium-toolbar-arrow-under"), s.classList.remove("medium-toolbar-arrow-over"), (c.top += this.diffTop)),
                                e < a ? ((c.left = l + a), (c.right = "initial")) : o - e < a ? ((c.left = "auto"), (c.right = 0)) : ((c.left = l + e), (c.right = "initial")),
                            ...
                            Array.prototype.slice.call(e.dataTransfer.files, 0).some(
                                function (e) {
                                    ...
                                    ((n = new FileReader()).readAsDataURL(e),
                                        ...
                                        d.util.insertHTMLCommand(this.document, '<img class="medium-editor-image-loading" id="' + t + '" />'),
                                        (n.onload = function () {
                    ...
                    (d.prototype = {
                        init: function (e, t) {
                            return (
                                (this.options = function (e, t) {
                                    return (
                                        t &&
                                        [["allowMultiParagraphSelection", "toolbar.allowMultiParagraphSelection"]].forEach(function (e) {
                                            t.hasOwnProperty(e[0]) && void 0 !== t[e[0]] && d.util.deprecated(e[0], e[1], "v6.0.0");
                                        }),
                                            d.util.defaults({}, t, e)
                                    );
                        ...
                        setup: function () {
                            ...
                            0 !== this.elements.length && ((this.isActive = !0), x.call(this), w.call(this)));
                        },
                        destroy: function () {
                            this.isActive &&
                            ((this.isActive = !1),
                        ...
                        serialize: function () {
                            for (var e = {}, t = this.elements.length, n = 0; n < t; n += 1) e["" !== this.elements[n].id ? this.elements[n].id : "element-" + n] = { value: this.elements[n].innerHTML.trim() };
                            return e;
                        },
                        ...
                        addBuiltInExtension: function (e, t) {
                            ...
                            switch (e) {
                                case "anchor":
                                    (n = d.util.extend({}, this.options.anchor, t)), (i = new d.extensions.anchor(n));
                                    break;
                                case "anchor-preview":
                                ...
                                case "keyboardCommands":
                                    i = new d.extensions.keyboardCommands(this.options.keyboardCommands);
                                    break;
                                case "paste":
                                ...
                                case "placeholder":
                                    ...
                                    break;
                                default:
                                    d.extensions.button.isBuiltInButton(e) && (i = t ? ((n = d.util.defaults({}, t, d.extensions.button.prototype.defaults[e])), new d.extensions.button(n)) : new d.extensions.button(e));
                            }
                        ...
                        execAction: function (e, t) {
                            var n,
                                i = /^full-(.+)$/gi.exec(e);
                            return (
                                i ? (this.saveSelection(), this.selectAllContents(), (n = T.call(this, i[1], t)), this.restoreSelection()) : (n = T.call(this, e, t)),
                                ("insertunorderedlist" !== e && "insertorderedlist" !== e) || d.util.cleanListDOM(this.options.ownerDocument, this.getSelectedParentElement()),
                                    this.checkSelection(),
                                    n
                            );
                        },
                        getSelectedParentElement: function (e) {
                            return void 0 === e && (e = this.options.contentWindow.getSelection().getRangeAt(0)), d.selection.getSelectedParentElement(e);
                        },
                        ...
                        exportSelection: function () {
                            var e = d.selection.getSelectionElement(this.options.contentWindow),
                                ...
                                n = null;
                            return 0 <= t && (n = d.selection.exportSelection(e, this.options.ownerDocument)), null !== n && 0 !== t && (n.editableElementIndex = t), n;
                        },
                        saveSelection: function () {
                            (this.posSaved = !0), (this.selectionState = this.exportSelection());
                        },
                        importSelection: function (e, t) {
                            var n;
                            e && ((n = this.elements[e.editableElementIndex || 0]), d.selection.importSelection(e, n, this.options.ownerDocument, t));
                        },
                            ...
                            if (-1 !== this.elements.indexOf(r)) {
                                try {
                                    if (
                                        ...
                                        e.url && d.util.deprecated(".url option for createLink", ".value", "6.0.0"),
                                        (t = e.url || e.value) &&
                                        0 < t.trim().length &&
                                        (o = this.options.contentWindow.getSelection()) &&
                                        ((n = (s = o.getRangeAt(0)).commonAncestorContainer),
                                        3 === s.endContainer.nodeType && 3 !== s.startContainer.nodeType && 0 === s.startOffset && s.startContainer.firstChild === s.endContainer && (n = s.endContainer),
                                            ...
                                            3 !== n.nodeType && 0 !== n.textContent.length && i === o
                                                ? ((s = i || r),
                                                    ...
                                                    r === s
                                                        ? d.selection.select(this.options.ownerDocument, s.firstChild, 0, s.lastChild, (3 === s.lastChild.nodeType ? s.lastChild.nodeValue : s.lastChild.childNodes).length)
                                                        : d.selection.select(this.options.ownerDocument, s, 0, s, s.childNodes.length),
                                                    (s = this.exportSelection()),
                                                0 === (s = d.util.findOrCreateMatchingTextNodes(this.options.ownerDocument, o, { start: i.start - s.start, end: i.end - s.start, editableElementIndex: i.editableElementIndex })).length &&
                                                ((o = this.options.ownerDocument.createDocumentFragment()).appendChild(n.cloneNode(!0)), (s = [o.firstChild.firstChild, o.firstChild.lastChild])),
                                                    d.util.createLink(this.options.ownerDocument, s, t.trim()),
                                                    (s = (o.firstChild.innerHTML.match(/^\s+/) || [""])[0].length),
                                                    d.util.insertHTMLCommand(this.options.ownerDocument, o.firstChild.innerHTML.replace(/^\s+/, "")),
                                                    (i.start -= s),
                                                    (i.end -= s),
                                                    this.importSelection(i))
                                                : this.options.ownerDocument.execCommand("createLink", !1, t),
                                            this.options.targetBlank || "_blank" === e.target
                                                ? d.util.setTargetBlank(d.selection.getSelectionStart(this.options.ownerDocument), t)
                                                : d.util.removeTargetBlank(d.selection.getSelectionStart(this.options.ownerDocument), t),
                                        e.buttonClass && d.util.addClassToAnchors(d.selection.getSelectionStart(this.options.ownerDocument), e.buttonClass)),
                                        this.options.targetBlank || "_blank" === e.target || e.buttonClass)
                                    ) {
                                        (a = this.options.ownerDocument.createEvent("HTMLEvents")).initEvent("input", !0, !0, this.options.contentWindow);
                                        for (var l = 0, c = this.elements.length; l < c; l += 1) this.elements[l].dispatchEvent(a);
                                    }
                                } finally {
                        ...
                        setContent: function (e, t) {
                            (t = t || 0), this.elements[t] && (((t = this.elements[t]).innerHTML = e), this.checkContentChanged(t));
                        },
                        getContent: function (e) {
                            return (e = e || 0), this.elements[e] ? this.elements[e].innerHTML.trim() : null;
                        },
                        checkContentChanged: function (e) {
                            (e = e || d.selection.getSelectionElement(this.options.contentWindow)), this.events.updateInput(e, { target: e, currentTarget: e });
                        },
                        resetContent: function (e) {
                            var t;
                            e
                                ? -1 !== (t = this.elements.indexOf(e)) && this.setContent(a[e.getAttribute("medium-editor-index")], t)
                        ...
                        addElements: function (e) {
                            ...
                            e.forEach(function (e) {
                                (e = y.call(this, e, this.id)), this.elements.push(e), this.trigger("addElement", { target: e, currentTarget: e }, e);
                            }, this);
                        },
                        removeElements: function (e) {
                            ...
                            this.elements = this.elements.filter(function (e) {
                                return -1 === t.indexOf(e) || (this.events.cleanupElement(e), e.getAttribute("medium-editor-textarea-id") && v(e), this.trigger("removeElement", { target: e, currentTarget: e }, e), !1);
                            }, this);
                        },
                    }),
                    (d.getEditorFromElement = function (e) {
                        var t = e.getAttribute("data-medium-editor-editor-index"),
                            e = e && e.ownerDocument && (e.ownerDocument.defaultView || e.ownerDocument.parentWindow);
                        return e && e._mediumEditors && e._mediumEditors[t] ? e._mediumEditors[t] : null;
                    }),
...
sof.home = function ($) {
    ...
    this.bindEvents = function () {
        ...
        $(".btn.copy-btn").tooltipster({ animation: "grow", content: "Скопировано", touchDevices: !0, trigger: "click", offsetY: -5, timer: 700 });
        $(".btn.copy-btn").on("click", function () {
            var text2copy = "";
            if ($(this).prev(".text-to-copy").length > 0) {
                text2copy = $(this).prev(".text-to-copy").text().trim();
            } else {
                text2copy = $(".b-payment_card_number span").text().trim().split(" ").join("");
            }
            sof.helper.copyToClipboard(text2copy);
        });
        var currentDate = new Date(),
            currentTime = currentDate.getTime();
        if (typeof payment_deadline !== "undefined" && payment_deadline > 0 && currentTime < payment_deadline) {
            ...
            var paymentTimeUpdate = setInterval(function () {
                ...
                if (currentTime < payment_deadline) {
                    ...
                    $(".b-payment_deadline div").attr("style", "width: " + percentage + "%;");
...
sof.pages = (function () {
    ...
    var bindFavoritesEvents = function () {
        ...
        $(".b-favorites_content__cats_list_item").on("click", ".remove-items", function () {
            ...
            if (_items_ids.length > 0) {
                ...
                if (!0 == result) {
                    _self.prop("disabled", !0);
                    sof.ajax(dle_root + "ajax/favorites/", { items: _items_ids, cat_id: _cat_id, action: "remove_items" }, function (response) {
                        if (response.success == !0) {
            ...
            $("#ps-favorites-content .select-cat-save").on("click", function () {
                ...
                if (_to_cat_id > 0) {
                    ...
                    if (!0 == result) {
                        _self.prop("disabled", !0);
                        _loader.show();
                        sof.ajax(dle_root + "ajax/favorites/", { from_cat_id: _from_cat_id, to_cat_id: _to_cat_id, items: _items_ids, action: "change_items_cat" }, function (response) {
                            if (response.success == !0) {
        ...
        var onOpen = function () {
            ...
            $("#ps-favorites-remove").on("click", function () {
                var _self = $(this),
                    _cat_id = _self.data("cat_id"),
                    _loader = _self.find(".loading"),
                    _items_num = parseInt($("#favorite-cat-" + _cat_id + " b.fb-1").text()),
                    result = !0;
                if (_items_num > 0) {
    ...
    var showPremModal = function () {
        var modal = null;
        if ($(".b-prem-modal").length > 0) {
            modal = $(".b-prem-modal");
            modal.addClass("active");
        } else {
            var modal = $(
                '<div class="b-prem-modal">' +
                '<button class="b-prem-modal-close"></button>' +
                '<div class="b-prem-modal-inner">' +
                '<a href="/" class="b-prem-modal-logo"></a>' +
                '<h3 class="b-prem-modal-title">' +
                "Відео високої якості та інші переваги доступні у Premium" +
                '<div class="b-prem-modal-subtitle">Всього 75 ₴/місяць</div>' +
                "</h3>" +
                '<a href="/" class="b-prem-modal-link">' +
                "<span>Оформити Premium та дивитись FullHD</span>" +
                "</a>" +
                '<button class="b-prem-modal-cancel">' +
                "Відмовитись і дивитись 720p з рекламою" +
                "</button>" +
                '<ul class="b-prem-modal-benefits">' +
                "<li><b>Відео високої якості</b>, від 1080p</li>" +
                "<li><b>Повністю без реклами</b> в плеєрі та банерів</li>" +
                "<li><b>Офлайн перегляд.</b> Скачуй і дивись навіть без інтернета</li>" +
                "<li><b>Дитячий акаунт</b> з “безпечними” релізами</li>" +
                "<li><b>Ексклюзивний дубляж</b> від HDRezka Studio</li>" +
                "</ul>" +
                "</div>" +
                "</div>"
            );
            $("body").append(modal);
            $(".b-prem-modal-cancel, .b-prem-modal-close")
                .off()
                .on("click", function () {
    ...
    var bindEvents = function () {
        ...
        $(".b-seriesupdate__block_date.collapsible").on("click", function () {
            var _self = $(this),
                act = $(this).find(".act"),
                block = act.closest(".b-seriesupdate__block").find(".b-seriesupdate__block_list"),
        ...
        $(".b-player-block-close").on("click", function () {
            $(".b-player-block-inform").removeClass("active");
        });
    };
    ...
    pub.buildPersonInfo = function (person) {
        ...
        html +=
            ...
            person.name +
            "</a>" +
            (person.edit_link != null ? ' <a href="' + person.edit_link + '" target="_blank"><span class="b-post-edit"></span></a>' : "") +
            "</div>";
        if (person.namealt != "") {
...
sof.tv = (function () {
    ...
    var bindAllEvents = function () {
        if (
            ($.cookie("tg_block_theboys_closed") != 1 && $('#tg-info-block-exclusive[data-entity="the_boys"]').length > 0) ||
            ($.cookie("tg_block_general_closed") != 1 && $('#tg-info-block-exclusive[data-entity="general"]').length > 0) ||
            ($.cookie("tg_block_inform_closed") != 1 && $('#tg-info-block-exclusive[data-entity="inform"]').length > 0)
        ) {
    ...
    pub.sendWatching = function () {
        ...
        var t = new Date().getTime();
        $.post(dle_root + "ajax/send_watching/?t=" + t, { action: "add", id: itemId, translator_id: cdnTranslatorId }, function (response) {
            if (!0 === response.success) {
                isWatched = !0;
            }
        });
    ...
    pub.displayPremiumHolder = function (event, translator_name) {
        if (event == "show") {
            $("#b-post__prem_translator_name").html(translator_name);
            $("#b-post__prem_holder").show();
        } else {
            $("#b-post__prem_translator_name").html("");
            $("#b-post__prem_holder").hide();
        }
    };
    ...
    var prepareNextEpisode = function () {
        ...
        if (CDNPlayerInfo.autoswitch == 1) {
            var _current_season = $(".b-simple_seasons__list .b-simple_season__item.active"),
                _current_episode = $(".b-simple_episodes__list .b-simple_episode__item.active"),
                _next_episode = null,
                _season = null,
                _episode = null;
            ...
            if (_season !== null && _episode !== null) {
                ...
                var t = new Date().getTime();
                cdnLatestData = { url: "get_cdn_series", params: { id: cdnItemId, translator_id: cdnTranslatorId, season: _season, episode: _episode, favs: $("#ctrl_favs").val(), action: "get_stream" } };
                cdnFallbackCount = 0;
                sof.ajax(
                    dle_root + "ajax/get_cdn_series/?t=" + t,
                    { id: cdnItemId, translator_id: cdnTranslatorId, season: _season, episode: _episode, favs: $("#ctrl_favs").val(), action: "get_stream" },
                    function (response) {
                        if ("object" !== typeof response) {
                            response = $.parseJSON(response);
                        }
                        if (response.success == !0) {
                            if (response.premium_content == 1) {
                                pub.displayPremiumHolder("show", _current_translator.html());
                            } else {
                                pub.displayPremiumHolder("hide");
                            }
    ...
    PlayerjsEvents = function (event, id, info) {
        ...
        if (event == "loaderror" || event == "networkErrorHls") {
        }
        if (event == "error") {
        }
        if (event == "reload") {
            try {
                ...
                if (metricsSent === null && metricsSentCount == 3) {
                    ...
                    ym(30584052, "reachGoal", "player_issue", { quality: list_qualities[current_quality_index], source: metricsSrc, translator_id: cdnTranslatorId, season: cdnSeason, episode: cdnSeason });
                }
            } catch (e) {}
        }
    ...
    pub.showAjaxError = function (text) {
        ...
        if (text === null) {
            text =
                ...
                (window.abc == !0 ? ", и обязательно <b><u>отключите</u></b> блокировщик рекламы" : "") +
    ...
    pub.initCDNMoviesEvents = function (id, translator_id, is_camrip, is_ads, is_director, web_host, is_logged, player_info) {
        cdnItemId = id || 0;
        ...
        checkHashContinue();
        cdnLatestData = { url: "get_cdn_series", params: { id: cdnItemId, translator_id: cdnTranslatorId, is_camrip: is_camrip, is_ads: is_ads, is_director: is_director, favs: $("#ctrl_favs").val(), action: "get_movie" } };
        cdnFallbackCount = 0;
        pub.buildCDNPlayer();
        $("#translators-list").on("click", ".b-translator__item", function () {
            ...
            if (!_self.hasClass("active") && !_self.hasClass("disabled")) {
                ...
                _self.addClass("active");
                var t = new Date().getTime();
                cdnLatestData = { url: "get_cdn_series", params: { id: cdnItemId, translator_id: cdnTranslatorId, is_camrip: _is_camrip, is_ads: _is_ads, is_director: _is_director, favs: $("#ctrl_favs").val(), action: "get_movie" } };
                cdnFallbackCount = 0;
                sof.ajax(
                    dle_root + "ajax/get_cdn_series/?t=" + t,
                    { id: cdnItemId, translator_id: cdnTranslatorId, is_camrip: _is_camrip, is_ads: _is_ads, is_director: _is_director, favs: $("#ctrl_favs").val(), action: "get_movie" },
                    function (response) {
                        if ("object" !== typeof response) {
                            response = $.parseJSON(response);
                        }
                        if (response.success == !0) {
                            if (response.premium_content == 1) {
                                pub.displayPremiumHolder("show", _self.html());
                            } else {
                                pub.displayPremiumHolder("hide");
                            }
                            CDNPlayerInfo.streams = response.url;
    ...
    pub.initCDNSeriesEvents = function (id, translator_id, season_id, episode_id, url, web_host, is_logged, player_info, callback) {
        ...
        checkHashContinue();
        cdnLatestData = { url: "get_cdn_series", params: { id: cdnItemId, translator_id: cdnTranslatorId, season: cdnSeason, episode: cdnEpisode, favs: $("#ctrl_favs").val(), action: "get_stream" } };
        cdnFallbackCount = 0;
        pub.buildCDNPlayer();
        $("#player")
        ...
        $("#translators-list")
            ...
            .on("click.player_translator", ".b-translator__item", function () {
                ...
                if (!_self.hasClass("active") && !_self.hasClass("disabled")) {
                    ...
                    _self.addClass("active");
                    var t = new Date().getTime();
                    cdnLatestData = { url: "get_cdn_series", params: { id: cdnItemId, translator_id: cdnTranslatorId, favs: $("#ctrl_favs").val(), action: "get_episodes" } };
                    cdnFallbackCount = 0;
                    sof.ajax(
                        dle_root + "ajax/get_cdn_series/?t=" + t,
                        { id: cdnItemId, translator_id: cdnTranslatorId, favs: $("#ctrl_favs").val(), action: "get_episodes" },
                        function (response) {
                            if ("object" !== typeof response) {
                                response = $.parseJSON(response);
                            }
        ...
        if (match !== null) {
            ...
            if (_item_translator.hasClass("active") || _tr_count == 0) {
                ...
                sof.ajax(
                    dle_root + "ajax/get_cdn_series/?t=" + t,
                    { id: cdnItemId, translator_id: cdnTranslatorId, season: cdnSeason, episode: cdnEpisode, favs: $("#ctrl_favs").val(), action: "get_stream" },
                    function (response) {
                        if ("object" !== typeof response) {
                            response = $.parseJSON(response);
                        }
                        if (response.success == !0) {
                            if (response.premium_content == 1) {
                                pub.displayPremiumHolder("show", _item_translator.html());
                            } else {
                                pub.displayPremiumHolder("hide");
                            }
                            $(".b-simple_season__item").removeClass("active");
            ...
            cdnLatestData = { url: "get_cdn_series", params: { id: cdnItemId, translator_id: cdnTranslatorId, season: cdnSeason, episode: cdnEpisode, favs: $("#ctrl_favs").val(), action: "get_episodes" } };
            cdnFallbackCount = 0;
            sof.ajax(
                dle_root + "ajax/get_cdn_series/?t=" + t,
                { id: cdnItemId, translator_id: cdnTranslatorId, season: cdnSeason, episode: cdnEpisode, favs: $("#ctrl_favs").val(), action: "get_episodes" },
                function (response) {
                    if ("object" !== typeof response) {
                        response = $.parseJSON(response);
                    }
    ...
    pub.sendWatchingRG = function () {
        if (cdnTranslatorId > 0) {
            var t = new Date().getTime();
            $.post(dle_root + "ajax/send_watching/?t=" + t, { action: "update_rg", id: cdnItemId, translator_id: cdnTranslatorId }, function (response) {
                if (!0 === response.success) {
                }
            });
        }
...
sof.comments = (function () {
    ...
    var initEditor = function (id) {
        var commentsTextarea = $("#comments-" + id),
            ...
            editor = new MediumEditor("#comments-" + id, {
                ...
                targetBlank: !0,
                anchorPreview: !1,
                toolbar: { static: !0, standardizeSelectionStart: 0, updateOnEmptySelection: !0, buttons: editorBtnsList },
                placeholder: { text: "Написать отзыв", hideOnClick: !1 },
                paste: { forcePlainText: !0 },
            });
        var editorElement = $("#" + commentsTextarea.attr("medium-editor-textarea-id"));
                ...
                if (!_submit_btn.prop("disabled")) {
                    ...
                    sof.ajax(dle_root + "ajax/add_comment/", data, function (response) {
                        if (response.success == !0) {
                            ...
                            if (wysiwygEnabled) {
                                var editorElement = $("#" + $("#comments-" + _form_id).attr("medium-editor-textarea-id"));
    ...
    var buildReplyForm = function (id, indent) {
        ...
        if (wysiwygEnabled) {
            html.find(".editor-wrapper").html('<textarea name="comments" id="comments-' + id + '"></textarea>');
        } else {
    ...
    pub.getCommentsUpdatesRequest = function (post_id, type, update_id, callback) {
        ...
        sof.ajax(
            ...
            { post_id: post_id, type: type, token: _user_token, update_id: update_id },
            function (response) {
                    ...
                    case "delete":
                        if ($("#comments-tree-item-" + response.comment_id).length > 0) {
                            var _user_id = parseInt($("#member_user_id").val()),
                                ...
                                _count_holder = $("#comment-id-" + response.comment_id + " .b-comment__likes_count")
                                    .show()
                                    .find("i");
    ...
    var setCommentsExpandEvents = function (id) {
        if (wysiwygEnabled) {
            var editorTextarea = $("#comments-" + id),
                editorElement = $("#" + editorTextarea.attr("medium-editor-textarea-id"));
...
sof.profile = (function () {
    ...
    var bindContinueEvents = function () {
        $(".b-completed__watch__list_item_controls-dropdown").on("click", function (e) {
            e.stopPropagation();
            var _self = $(this),
                _list = _self.next(".b-completed__watch__list_item_controls-dropdown_list");
            _list.toggle();
            $("#wrapper").off("click.dropdown_controls", { _self: _self, _list: _list }, closeContinueControlsList).on("click.dropdown_controls", { trigger: _list, _list: _list }, closeContinueControlsList);
        });
    };
    var bindPaymentsEvents = function () {
        var method_checked = !1;
        ...
        if (!method_checked) {
            $(".payment_method-radio:first").prop("checked", !0);
        }
        $(".payment_method-radio").on("change", function () {
            $(".payment_method-radio").removeClass("error");
            $(".price-list").removeClass("crypto_payment card_payment binancepay p2pkassa").addClass($(this).val());
        });
        $(".currency-pay-dropdown-current").on("click", function () {
            if ($(".currency-pay-dropdown-list").hasClass("active")) {
                $(".currency-pay-dropdown-list").removeClass("active");
                $("#wrapper").off("click.close-currency-pay-dropdown");
            } else {
                $(".currency-pay-dropdown-list").addClass("active");
                $("#wrapper").off("click.close-currency-pay-dropdown").on("click.close-currency-pay-dropdown", CloseCurrencyPayDropdown);
            }
        });
        var CloseCurrencyPayDropdown = function (e) {
            var currencyPayDropdown = $(".currency-pay-dropdown");
            if (!$(e.target).closest(currencyPayDropdown).is(currencyPayDropdown)) {
                $(".currency-pay-dropdown-list").removeClass("active");
                $("#wrapper").off("click.close-currency-pay-dropdown");
            }
        };
        $(".card-prices, .crypto-prices").on("change", 'input[name="amount"], input[name="crypto-amount"]', function () {
            var this_ = $(this),
                value = this_.val();
            if (this_.attr("name") == "crypto-amount") {
                if ($('.card-prices .pl-item input[value="' + value + '"]').length > 0) {
                    $(".card-prices .pl-item input").prop("checked", !1);
                    $('.card-prices .pl-item input[value="' + value + '"]').prop("checked", !0);
                }
            } else {
                if ($('.crypto-prices .pl-item input[value="' + value + '"]').length > 0) {
                    $(".crypto-prices .pl-item input").prop("checked", !1);
                    $('.crypto-prices .pl-item input[value="' + value + '"]').prop("checked", !0);
                }
            }
        });
